...
<?php
  ...
  if(empty($message)){
  	//empty message
  	$_SESSION["message"] = "Your request to stop the instance is failed, please try again";
  } else{
...
<?php
	...
	if(empty($messagebody)){
		...
		$rec_message = "1/1/off/pass";   	//?????

		$rec_msg_array = explode("/", $rec_message);
		if ($rec_msg_array[2] = "off"){
			if($rec_msg_array[3] = "pass"){
				$showlist = ResourceAllocation::found_mobile_Result_by_instanceId($rec_msg_array[0],$rec_msg_array[1],"off");
				...
				<?php include("aside_bar.php"); ?>
	         	<article class="col-lg-10">
	         		...
	         		<p class="bg-info" style="height:3em; margin-left:1em;">
	         			...
	         			<h3green>Your instance is stopped.</h3green> <br></p>
